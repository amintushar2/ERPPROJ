            ...
            <form action="" method="" id="report">
                <div class="container col-lg-6 p-3" id="">
                        ...
                        <div class="col-sm-8"id="div1">
                            <select class="form-select" id="report_list">
                                ...
                                @foreach ($reportLits as $reportLits)
                                    <option value="{{ $reportLits->report_id }}">{{ $reportLits->report_title }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="mb-3 row container"id="P_SECTION_NO_div">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="P_SECTION_NO" id="P_SECTION_NO"
                                placeholder="" value="{{ old('P_SECTION_NO') }}">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row container"id="P_INCREMENT_TYPE_div">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="P_INCREMENT_TYPE" id="P_INCREMENT_TYPE"
                                placeholder="" value="{{ old('P_INCREMENT_TYPE') }}">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row container"id="P_PAYMENT_DATE_div">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="P_PAYMENT_DATE" id="P_PAYMENT_DATE"
                                placeholder="" value="{{ old('P_PAYMENT_DATE') }}">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row container"id="P_PRINT_DATE_div">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="P_PRINT_DATE" id="P_PRINT_DATE"
                                placeholder="" value="{{ old('P_PRINT_DATE') }}">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row container"id="P_STATUS_div">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="P_STATUS" id="P_STATUS"
                                placeholder="" value="{{ old('P_STATUS') }}">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row container"id="P_FROM_DATE_div">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="P_FROM_DATE" id="P_FROM_DATE"
                                placeholder="" value="{{ old('P_FROM_DATE') }}">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row container" id="P_TO_DATE_div">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="P_TO_DATE" id="P_TO_DATE"
                                placeholder="" value="{{ old('P_TO_DATE') }}">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row container"id="P_ATT_DATE_div">
                        ...
                        <div class="col-sm-8">
                            <input type="date" class="form-control" name="P_ATT_DATE" id="P_ATT_DATE"
                                placeholder="" value="{{ old('P_ATT_DATE') }}">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row container"id="P_EMP_NO_div">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="P_EMP_NO" id="P_EMP_NO"
                                placeholder="" value="{{ old('P_EMP_NO') }}">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row container"id="P_DES_NO_div">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="P_DES_NO" id="P_DES_NO"
                                placeholder="" value="{{ old('P_DES_NO') }}">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row container"id="P_WRK_ENT_div">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="P_WRK_ENT" id="P_WRK_ENT"
                                placeholder="" value="{{ old('P_WRK_ENT') }}">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row container"id="P_SHIFT_CODE_div">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="P_SHIFT_CODE" id="P_SHIFT_CODE"
                                placeholder="" value="{{ old('P_SHIFT_CODE') }}">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row container"id="P_BANK_SAL_div">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="P_BANK_SAL" id="P_BANK_SAL"
                                placeholder="" value="{{ old('P_BANK_SAL') }}">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row container"id="P_BANK_NAME_div">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="P_BANK_NAME" id="P_BANK_NAME"
                                placeholder="" value="{{ old('P_BANK_NAME') }}">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row container"id="P_LATE_DEDUCT_div">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="P_LATE_DEDUCT" id="P_LATE_DEDUCT"
                                placeholder="" value="{{ old('P_LATE_DEDUCT') }}">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row container"id="P_LETTER_NO_div">
                        ...
                        <div class="col-sm-8">
                            <input type="number" class="form-control" name="P_LETTER_NO" id="P_LETTER_NO"
                                placeholder="" value="{{ old('P_LETTER_NO') }}">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row container"id="P_FOOD_DEDUCT_div">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="P_FOOD_DEDUCT" id="P_FOOD_DEDUCT"
                                placeholder="" value="{{ old('P_FOOD_DEDUCT') }}">
                        </div>
                    </div>
