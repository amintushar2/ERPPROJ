...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Rajdhani:wght@500;600;700&family=Noto+Sans:wght@300;400;500&display=swap" rel="stylesheet">
    ...
    <style>
        ...
        ═══════════════════════════════════════════ */
        body.hold-transition { font-family: 'Noto Sans', sans-serif !important; }
        ...
        .main-header .container-fluid h4::before { left: -10px; }
        .main-header .container-fluid h4::after  { right: -10px; }
        ...
        .nav-sidebar { padding-bottom: 20px !important; }
        ...
        .nav-sidebar > .nav-item.menu-open > .nav-link .nav-icon { opacity: 1; }
        ...
        .nav-sidebar > .nav-item.menu-open > .nav-link > p > .right { transform: rotate(-90deg) !important; }
        ...
        .nav-sidebar .nav-treeview > .nav-item > .nav-link:hover::before { background: var(--amber); }
        .nav-sidebar .nav-treeview > .nav-item > .nav-link.active {
            color: var(--amber) !important;
            background: rgba(245,158,11,.12) !important;
        }
        .nav-sidebar .nav-treeview > .nav-item > .nav-link.active::before { background: var(--amber); }
        ...
        .nav-sidebar .nav-treeview > .nav-item > .nav-link .nav-icon {
            ...
            text-align: center !important;
            color: var(--steel) !important;
            display: none; /* hidden — we use ::before dot instead */
        }
        ...
        .nav-sidebar .nav-treeview .nav-item.has-treeview > .nav-link:hover { color: var(--amber-lt) !important; }
        .nav-sidebar .nav-treeview .nav-item.has-treeview.menu-open > .nav-link { color: var(--amber) !important; }
        ...
        .nav-sidebar .nav-treeview .nav-treeview > .nav-item > .nav-link:hover::before { background: var(--amber); }

        /* L3 icons */
        .nav-sidebar .nav-treeview .nav-treeview > .nav-item > .nav-link .nav-icon { display: none; }
        ...
        .sidebar-collapse .main-sidebar:not(:hover) .nav-sidebar .nav-link p { display: none; }
        .sidebar-collapse .main-sidebar:hover { width: var(--sidebar-w) !important; }
        .sidebar-collapse .main-sidebar { width: 60px !important; transition: width .25s ease !important; }
        ...
        .sidebar::-webkit-scrollbar-thumb { background: var(--navy-4); border-radius: 2px; }
        .sidebar::-webkit-scrollbar-thumb:hover { background: var(--amber); }
    </style>
</head>
...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="info">
                <a href="#" class="d-block"><span>FDL</span> ERP<small>Enterprise Resource Planning</small></a>
            </div>
        </div>
