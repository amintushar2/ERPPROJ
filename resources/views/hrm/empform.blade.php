...
<body class="sidebar-mini layout-fixed sidebar-collapse">
        ...
        <div class="content-wrapper">
            ...
            <div class="mode-banner">
                <div style="display:flex;align-items:center;gap:12px;">
                    @if (isset($emp))
                        <span class="badge-pill">✏ EDIT</span>
                                    ...
                                    <div class="col-md-4">
                                        <div class="row p-1">
                                            ...
                                            <div class="col-sm-8"><input type="text" class="form-control"
                                                    ...
                                                    value="{{ $emp->last_name ?? '' }}" placeholder="Last Name">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-3">
                                        <div class="row p-1">
                                            ...
                                            <div class="col-sm-7"><input type="text"
                                                    class="form-control date-pick" name="dob" id="dob"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="row p-1">
                                            ...
                                            <div class="col-sm-7"><input type="text"
                                                    class="form-control date-pick" name="as_on"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="row p-1">
                                            ...
                                            <div class="col-sm-8"><input type="text"
                                                    class="form-control date-pick" name="id_card_issue"
                                    ...
                                    <div class="col-md-4">
                                        <div class="row p-1">
                                            ...
                                            <div class="col-sm-8"><input type="text"
                                                    class="form-control date-pick" name="valid_till"
                            ...
                            <div class="sec-card-body">
                                <div class="row align-items-start g-4">
                                    ...
                                    @php
                                        ...
                                        $photoUrl = $photoFile
                                            ? 'http://192.168.18.205:81/' . $photoFile . '?v=' . time()
                                            : null;
                                    @endphp
                                    <div class="col-md-3 col-sm-6">
                                        <div class="img-card">
                                            ...
                                            <input class="form-control" type="file" id="photoInput"
                                                name="photo" accept="image/*" style="width:100%;">

                                            {{-- Preview box: 130×150 portrait --}}
                                            <div class="img-preview-wrap" id="photoBox"
                                                style="width:130px;height:150px;">
                                                <img id="photoPreview" src="{{ $photoUrl ?? '' }}"
                                                    alt="Employee Photo" width="130" height="150"
                                    ...
                                    @php
                                        ...
                                        $signFile = $emp->Z ?? null;
                                        $signUrl = $signFile
                                            ? 'http://192.168.189.205:81/emp_sign/' . $signFile . '?v=' . time()
                                            : null;
                                    @endphp
                                    <div class="col-md-4 col-sm-6">
                                        <div class="img-card">
                                            ...
                                            {{-- File input --}}
                                            <input class="form-control" type="file" id="signInput"
                                                name="signature" accept="image/*" style="width:100%;">
    ...
    <script src="{{ URL::asset('mainjs/moment.min.js') }}"></script>
