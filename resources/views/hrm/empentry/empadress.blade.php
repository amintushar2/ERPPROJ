            ...
            <div class="form-container">
               ...
               <div class="row">
                   <div class="col-md">
                       ...
                       <label for="p_police_station" class="col-sm-3 col-form-label">P.S : </label>
                           <div class="col-sm-7">
                           <select class="form-select" aria-label="Default select example" name="p_police_station"
                            id="p_police_station" value="{{old('p_police_station')}}">
                   ...
                   <div class="col-md">
                       ...
                       <label for="p_district" class="col-sm-3 col-form-label">District : </label>
                           <div class="col-sm-8">
                           <select class="form-select" aria-label="Default select example" name="p_district"
                            id="p_district" value="{{old('P_district')}}">
               ...
               <div class="row">
                   ...
                   <div class="col-md">
                       ...
                       <label for="p_phone" class="col-sm-3 col-form-label">Phone No :</label>
                           <div class="col-sm-7">
                           <input type="tel" class="form-control" name="p_phone" id="p_phone" placeholder="phone No"
                            value="{{old('P_phone')}}" />
               ...
               <div class="row">
                   <div class="col-md">
                       ...
                       <label for="p_pin_code" class="col-sm-3 col-form-label">National Id:</label>
                           <div class="col-sm-7">
                           <input type="tel" class="form-control" name="p_cperson" id="p_cperson" value="{{old('P_cperson')}}"
                   ...
                   <label for="r_district" class="col-sm-3 col-form-label">District : </label>
                       ...
                       <div class="row p-1">
                           ...
                           <select class="form-select" aria-label="Default select example" name="r_district"
                            id="r_district" value="{{old('r_district')}}">
                            <option selected placeholder="Select district">Select District</option>
               ...
               <div class="row">
                   <div class="col-md">
                       ...
                       <label for="r_phone" class="col-sm-3 col-form-label">Phone No :</label>
                           <div class="col-sm-7">
                           <input type="tel" class="form-control" name="r_phone" id="r_phone" placeholder="phone No"
                            value="{{old('r_phone')}}" />
                   ...
                   <label for="r_mobile" class="col-sm-3 col-form-label">Mobile No :</label>
                       ...
                       <div class="row p-1">
                           <div class="col-sm-8">
                           <input type="tel" class="form-control" name="r_mobile" id="r_mobile" value="{{old('r_mobile')}}"
