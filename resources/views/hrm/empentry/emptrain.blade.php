...
<div class="tab-pane fade" id="train" role="tabpanel" aria-labelledby="train-tab" tabindex="7">
    <form action="" method=""id="empTrain">
            ...
            <div class="row">
                <div class="col-md">
                    <div class="row p-1">
                        ...
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="empnotraining" id="empnotraining"
        ...
        <table id="sal_table" class="table table-bordered table-striped" style="width:100%">
            <thead class="bg-dark text-light" style="background-color:rgb(94, 21, 94)">
                <tr>
                    ...
                    <th style="width:10px; text-align:center">Skill Type</th>
                    <th style="width:10px; text-align:center">CERTIFICATE</th>
                    <th style="width:10px; text-align:center">Conducted By</th>
                    <th style="width:20px; text-align:center">From </th>
                    <th style="width:10px; text-align:left">To</th>
                    <th style="width:10px; text-align:center">Total Days</th>
         

                </tr>
            </thead>
            <tbody id="emp_train_data">
