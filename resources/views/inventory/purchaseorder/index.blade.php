    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row g-3">
                ...
                <div class="col-md-2">
                    <label class="form-label">PO Number <small
                            class="text-muted fw-normal text-lowercase">(auto)</small></label>
                    <input type="text" class="form-control form-control-sm" id="PUR_ORDER_PK" readonly>
                </div>

                <div class="col-md-2">
                    <label class="form-label">PO Ref No. <small
                            class="text-muted fw-normal text-lowercase">(auto)</small></label>
                ...
                <div class="col-md-2">
                    ...
                    <input type="number" class="form-control form-control-sm" id="CURRENCY_RATE" value="1"
                        step="0.0001" onchange="recalcAll()">
                </div>
    ...
    <script>
        ...
        async function doSearch() {
            ...
            try {
                ...
                // 🔥 UX IMPROVEMENT
                document.getElementById('block-style').scrollIntoView({
                    behavior: 'smooth'
                });
        ...
        function loadMaster(data) {
            console.log('Loading master data:', data);
    ...
    <td class="text-center">
      <button class="btn btn-outline-danger btn-sm" onclick="removeDetailRow(${idx})">
        ...
        const STD_TERMS = [{
            ...
            {
                id: 'TRM-02',
                terms: 'Goods must conform to approved samples.'
            },
            {
                id: 'TRM-03',
                terms: 'Supplier bears all inspection costs.'
            },
        ];
